...
from model.HM_model_builder import Summarizer
from model.trainer_builder import build_trainer
from model.predictor_builder import build_predictor
from utils.e_dataloader import load_dataset_train, load_dataset_val
import torch
import random

from utils import e_dataloader, distributed
...
def train(args,device_id):
    ...
    def train_iter_fct():
        return e_dataloader.GraphDataLoader(args, load_dataset_train(args, 'train', shuffle=True), symbols, args.batch_size, device,
...
def validate(args, device_id, pt, step):
    ...
    valid_iter = e_dataloader.GraphDataLoader(args, load_dataset_val(args, 'valid', shuffle=False), symbols,
...
def test(args, pt, step):
    ...
    test_iter = e_dataloader.GraphDataLoader(args, load_dataset_val(args, args.dataset, shuffle=False), symbols,
